...
e.g::
    ...
    git tag -m v2.0.2.0 v2.0.2.0

Here, the first three version numbers identify the version of the erfa library
that is included (and you should make sure the git submodule ``liberfa/erfa``
is at the correct tag as well) and the fourth number identifies the version of
the wrappers for the given erfa version.
